...
/**
 * Request validation for marking item as Damaged
 *
 ...
 */
class MarkAsDamagedRequest extends FormRequest
{
    ...
    {
        return [
            'reason.required' => 'Reason for marking item as damaged is required.',
